...
-Latest Tweet: <div align="center">
    <a href=https://twitter.com/Wtscrackin/status/1555497716708433923 style="text-decoration:none; padding:2% display:flex; flex-direction:column; justify-content:space-around; aling-items:center;">
    <div align="center" style="background-color:#0d0d0d; border-radius:16px; width:
    60%;">
    <p style="color:#fafafa; width:50%; font-size:1.2rem;">GM beautiful people, yesterday i used AWS amplify for the first time and it was confusing! Hahahaha</p>
